...
public class JGFTimer {
    ...
    public JGFTimer(final String name, final String opname) {
        this.name = name;
        this.opname = opname;
        reset();
    }
    
    public JGFTimer(final String name, final String opname, final int size) {
        this.name = name;
        this.opname = opname;
        this.size = size;
        reset();
    ...
    public JGFTimer(final String name) {
        this(name, "");
    }
    ...
    public void addops(final double count) {
        opcount += count;
    }
    
    public void addtime(final double added_time) {
        time += added_time;
    }
